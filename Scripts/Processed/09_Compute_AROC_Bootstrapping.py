...
####################################################################################################
# CODE DESCRIPTION
# 09_Compute_AROC_Bootstrapping.py computes the area under the ROC curves (AROC), including the bootstrapped 
...
DirOUT = "Data/Compute/09_AROC_Bootstrapping"
####################################################################################################
...
for indSystemFC in range(len(SystemFC_list)):
      ...
      for EFFCI in EFFCI_list:
            ...
            # Computing AROC for a specific VRE
