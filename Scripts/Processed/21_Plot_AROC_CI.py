...
##########################################################################################
# CODE DESCRIPTION
# 21_Plot_AROC_CI.py plots AROC and confidence intervals (CI).
...
DirIN = "Data/Compute/20_AROC_Bootstrapping"
DirOUT = "Data/Plot/21_AROC"
##########################################################################################
...
for EFFCI in EFFCI_list:
       ...
       # Plotting AROC values for a specific VRT
      for MagnitudeInPerc_Rain_Event_FR in MagnitudeInPerc_Rain_Event_FR_list:

            print("Plotting AROC values for EFFCI>=" + str(EFFCI) + ", VRT>=tp(" + str(MagnitudeInPerc_Rain_Event_FR) + "th percentile) ...") 
            ...
            for RegionName in RegionName_list: 
                  ...
                  for indSystemFC in range(len(SystemFC_list)):
                        ...
                        FileNameIN_temp = "AROC_" + f"{Acc:02d}" + "h_VRT" + f"{MagnitudeInPerc_Rain_Event_FR:02d}" + "_" + SystemFC + "_EFFCI" + f"{EFFCI:02d}" + "_" + RegionName + ".npy"
                  ...
                  FileNameOUT_temp = "AROC_" + f"{Acc:02d}" + "h_VRT" + f"{MagnitudeInPerc_Rain_Event_FR:02d}" + "_EFFCI" + f"{EFFCI:02d}" + "_" + RegionName + ".jpeg"
